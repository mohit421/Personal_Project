...
// Even though we can create a arrow function version of below code like above but , preffered the rgular function syntax here
// for two reason ... 1. Easier to read than arrow function 2. Enabled hoisting 
...
function autoPlay() {
  if (!isAutoPlaying) {
    ...
    isAutoPlaying = true;
    // when the game is auto playing , change the text in tht button to 'Stop Playin"
    ...
    // when the game is not playig, change the text back to 'Auto play
    document.querySelector('.js-auto-play-button')
      .innerHTML = 'Auto Play'
  }
}
